package com.vince.gulimall.product.app;
...
import com.vince.gulimall.product.vo.BrandVo;
...
public class CategoryBrandRelationController {
    ...
    public R relationBransList(@RequestParam(value = "catId", required = true) Long catId) {
        ...
        // 增加 Objects::nonNull 过滤掉 list 中的 null 元素
        List<BrandVo> collect = vos.stream()
                .filter(item -> item != null) // 核心修复：过滤掉不存在的品牌对象
                .map(item -> {
